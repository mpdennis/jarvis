...
Luxfile = open("LuxOutput.txt", "w")
Luxfile.write("Luminosity Data, Lux\n")

Tempfile = open("TempOutput.txt", "w")
Tempfile.write("Temperature Data, Celsius\n")

Pressurefile = open("PressureOutput.txt", "w")
Pressurefile.write("Air Pressure Data, Pascals\n")

Vibrationfile = open("VibrationOutput.txt", "w")
Vibrationfile.write("Vibration Data, Voltage\n")

SurfaceTempfile = open("SurfaceTempOutput.txt", "w")
SurfaceTempfile.write("Surface Temp Data, Celsius\n")
...
while True:
	...
	Vibrationfile.write("%.4f" % volts3)	
	Vibrationfile.write("\n")       
 
	volts5 = adc5.readADCSingleEnded(2, gain, sps) / 1000
        temp = (volts5 - .5) / .01
        print ("%.1f" % temp), "degrees Celsius"	
	SurfaceTempfile.write("%.1f" % temp)
	SurfaceTempfile.write("\n")
